...
public class ImprovedAlgrithm {
	...
	ArrayList<ArrayList<ArrayList<Integer>>> getshowcomparisons(){
		return showcomparisons;
	}
	
	ArrayList<ArrayList<Integer>> getshowdata(){
		return showdata;
	}
	
	ArrayList<Integer> getshownumbersofcomparison(){
		return shownumbersofcomparison;
	}
	
	ArrayList<Integer> getshownumbersofdata(){
		return shownumbersofdata;
				
	}
	
	int getmaxnumberamongnodes(){
		return min;
	}
	...
	void Runit()
	{
		...
		int N=8;
		min=14;
		showcomparisons = new ArrayList<ArrayList<ArrayList<Integer>>>();
		showdata= new ArrayList<ArrayList<Integer>>();
		shownumbersofcomparison= new ArrayList<Integer>();
		shownumbersofdata = new ArrayList<Integer>();
